            ...
            <form method="POST" action="" class="space-y-4" id="studentForm">
                <div class="flex space-x-4">
                    ...
                    <div class="w-full">
                        ...
                        <select id="yearSelect" name="year" class="select-custom w-full" onchange="updateYear(this.value)">
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            <tr class="table-row-hover">
                                <td class="whitespace-nowrap px-6 py-4">
                                    <input type="text" name="name[]" required class="form-input-focus w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 px-3 py-2.5 border bg-white text-gray-700 placeholder-gray-400 text-base" placeholder="Full name" autocomplete="off">
                                </td>
                                <td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                                    <button type="button" onclick="removeRow(this)" class="btn-danger inline-flex items-center px-3.5 py-2.5 border border-red-300 shadow-sm text-sm font-semibold rounded-md text-red-700 bg-white hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Remove</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0 sm:space-x-4 mobile-stack">
                    <div class="w-full sm:w-auto">
                        <button type="button" onclick="addRow()" class="btn-primary w-full sm:w-auto inline-flex items-center px-4 py-2.5 border border-transparent text-sm font-semibold rounded-md shadow-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">Add Another Student</button>
                    </div>
                    <div class="w-full sm:w-auto">
                        <button type="submit" class="btn-success w-full sm:w-auto inline-flex items-center px-4 py-2.5 border border-transparent text-sm font-semibold rounded-md shadow-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">Save All Students</button>
                    </div>
                </div>
            </form>
        </div>
